                    ...
                    >
                        {/* <Box sx={{ display: "flex", gap: 5 }}>
                            ...
                            <Button
                                ...
                                color="blue"
                                variant={
                                    openButtonToggler ? "contained" : "outlined"
                                }
                            >
                                {t("OPEN_FOR_BID")}
                            </Button>
                                    ...
                                    <Box>
                                        <Stack direction="column" spacing={2}>
                                            ...
                                            <input
                                                ...
                                                type="text"
                                                placeholder={t(
                                                    "ADD_TIER_PLACEHOLDER_ENTER_TITLE_HERE"
                                                )}
                                                name="nftTitle"
                                                required
                                                style={{
                                        ...
                                        >
                                            ...
                                            <textarea
                                                placeholder={t(
                                                    "ADD_TIER_PLACEHOLDER_PROVIDE_A_DETAILED_DESCRIPTION_OF_THE_ITEM"
                                                )}
                                                name="nftDescription"
                                                required
                                                style={{
                                        ...
                                        >
                                            ...
                                            >
                                                <input
                                                    ...
                                                    type="number"
                                                    placeholder={t(
                                                        "ADD_TIER_PLACEHOLDER_ENTER_NFT_BASE_PRICE"
                                                    )}
                                                    name="nftPrice"
                                                    style={{
                                                        fontSize: "14px",
